...
from src.main.app.schema.user_schema import (
    ...
    ImportUsersRequest,
    ImportUser, BatchPatchUsersRequest,
)
...
async def batch_create_users(
    ...
    user_list: list[User] = [
        User(**user_record.model_dump()) for user_record in user_records
    ]
...
async def import_users(
    ...
    import_users_resp: list[ImportUser] = await user_service.import_users(
        req=req
    )
